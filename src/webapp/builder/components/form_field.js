...
import RuleEditorComponent, { RULE_MODE_BUILDER } from '../../rule_editor/components/editor';
import DecisionTypeahead from './decision_typeahead';
...
export default class BuilderFormFieldComponent extends React.Component {
     ...
     */
    getId() {
        return 'field_' + this.object.uid + '_' + this.field[0];
    }
     ...
     */
    getValue() {
        return this.object[this.field[0]] ? this.object[this.field[0]] : '';
    }
    ...
    onChange(e) {
        switch (this.getFieldType()) {
            ...
            case 'textarea':
            case 'number': {
                this.object[this.field[0]] = e.target.value;
                break;
            }
            case 'checkbox': {
                this.object[this.field[0]] = e.target.checked;
                break;
            }
            case 'code': {
                this.object[this.field[0]] = JSON.stringify(e);
                break;
            }
            case 'typeahead': {
                this.object[this.field[0]] = e;
                break;
            }
        }
        this.setState({
    ...
    onRteChange(content, delta, source, editor) {
        this.object[this.field[0]] = editor.getHTML();
        clearTimeout(this.timeout);
        this.hasUserInput = true;
        this.timeout = setTimeout(this.onUpdateTimeout, UPDATE_TIMEOUT);
    }
    ...
    onUpdateTimeout() {
        clearTimeout(this.timeout);
        Events.dispatch('update', this.object);
    }
    ...
    onRuleTemplate(e) {
        if (
            !(this.object instanceof DecisionRule) ||
            (
                this.hasUserInput && (
                    this.object[this.field[0]] && this.object[this.field[0]] != 'Rule ' + this.object.uid) &&
                    this.object[this.field[0]] != e.detail.label
                )
        ) {
            return;
        }
        ...
        switch (this.field[0]) {
            case 'label': {
                this.object[this.field[0]] = e.detail.label;
                this.setState({
                    value: this.object[this.field[0]]
                });
